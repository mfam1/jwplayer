<?php 
# Possible Input : 720 (default) | 480 | 720 | 1080 | ld | sd | hd | fhd 
define('YDRIVE_DEFAULT_RESOLUTION', 720);
...
class YDrive {
    ...
    private function _getCode($in = 720){
        switch ($in){
            case "sd":
            case "480":
                $this->v_code = 59;
    ...
    private function _getVideoData(){
        if(!$this->gdid) die("Google Drive ID");
    ...
    public function stream(){
    	...
    	header('Developed-By: WGTutoriales');
